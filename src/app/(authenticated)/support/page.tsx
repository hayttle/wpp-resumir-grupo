          ...
          <Card className="border-gray-200 shadow-lg">
            <CardHeader>
              <CardTitle className="flex items-center space-x-2">
                ...
                <span>Fale direto com o desenvolvedor</span>
              </CardTitle>
              <CardDescription>
                Preencha o formulário abaixo e entre em contato diretamente pelo WhatsApp
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-8">
                ...
                <div className="space-y-4">
                  <h3 className="text-lg font-semibold text-gray-900 mb-4">Descreva seu Problema ou Dúvida</h3>
                  ...
                  <div>
                    ...
                    <textarea
                      id="problem"
                      rows={6}
                      placeholder="Descreva detalhadamente o problema que você está enfrentando ou dúvida ..."
                  ...
                  <div className="flex items-center space-x-3 p-4 bg-green-50 rounded-lg">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">(73) 98838-9770</p>
